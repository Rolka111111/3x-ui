...
func (s *ServerService) GetXrayVersions() ([]string, error) {
	url := "https://api.github.com/repos/LuckyLuke-a/Xray-core/releases"
	resp, err := http.Get(url)
	if err != nil {
		return nil, err
	}
...
func (s *ServerService) downloadXRay(version string) (string, error) {
	...
	url := fmt.Sprintf("https://github.com/LuckyLuke-a/Xray-core/releases/download/%s/%s", version, fileName)
	resp, err := http.Get(url)
	if err != nil {
		return "", err
	}
