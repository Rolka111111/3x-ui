...
func (s *ServerService) GetXrayVersions() ([]string, error) {
	url := "https://api.github.com/repos/Rolka111111/Xray-core/releases"
	resp, err := http.Get(url)
	if err != nil {
		return nil, err
	}
...
func (s *ServerService) downloadXRay(version string) (string, error) {
	...
	url := fmt.Sprintf("https://github.com/Rolka111111/Xray-core/releases/download/%s/%s", version, fileName)
	resp, err := http.Get(url)
	if err != nil {
		return "", err
	}
